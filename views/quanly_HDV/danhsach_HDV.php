...
<body>
  ...
  <div class="stats">
    <div class="stat-card">
      <div class="stat-title">Tổng số HDV</div>
      <div class="stat-value" id="total-guides">0</div>
    </div>
    <div class="stat-card">
      <div class="stat-title">Đánh giá trung bình</div>
      <div class="stat-value" id="avg-rating">N/A</div>
    </div>
    <div class="stat-card">
      <div class="stat-title">Số tour đang hoạt động</div>
    ...
    quickSearchInput.addEventListener('input', function() {
      ...
      if (searchTerm === '') {
        ...
        const filtered = allGuides.filter(g => {
          ...
          const languages = (g.languages || '').toLowerCase();
          const status = (g.status || '').toLowerCase();
          const healthStatus = (g.health_status || '').toLowerCase();
          const birthDate = (g.birth_date || '').toLowerCase();
          const experience = (g.experience_years || g.experience || '').toString().toLowerCase();
          ...
          return fullName.includes(searchTerm) || 
                 ...
                 healthStatus.includes(searchTerm) ||

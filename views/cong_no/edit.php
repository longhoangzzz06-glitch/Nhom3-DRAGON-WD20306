        ...
        <div class="card-body">
            ...
            <form action="index.php?act=cap-nhat-congno&method=update" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="nha_cung_cap_id" value="<?= $congno['nha_cung_cap_id'] ?>" class="form-control">
                </div>

                <div class="mb-3">
                    <label class="form-label">Tour</label>
                    <input type="number" name="tour_id" value="<?= $congno['tour_id'] ?>" class="form-control">
                </div>

...
<div class="max-w-xl mx-auto mt-10 bg-white p-6 rounded-xl shadow-lg">
    <h2 class="text-2xl font-bold text-green-600 mb-4">Tạo HDV thành công!</h2>

    <p class="text-gray-700">Mật khẩu tạm của HDV là:</p>

    <div class="mt-4 p-3 bg-gray-100 text-red-600 font-bold text-xl rounded border border-gray-300">
        <?= $matKhauTam ?>
    </div>

    <p class="mt-4 text-gray-600">Hãy gửi mật khẩu này cho HDV để họ đăng nhập lần đầu.</p>

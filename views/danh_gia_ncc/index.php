                        ...
                        <?php if (!empty($danhgias)): ?>
                            <?php foreach ($danhgias as $d): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?act=view-cap-nhat-danhgia&id=<?= $d['id'] ?>" class="btn btn-sm btn-warning">Sửa</a>

                                        <a href="index.php?act=xoa-danhgia&id=<?= $d['id'] ?>" class="btn btn-sm btn-danger"

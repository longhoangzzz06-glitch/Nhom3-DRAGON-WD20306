                        ...
                        <?php if (!empty($hopdongs)): ?>
                            <?php foreach ($hopdongs as $h): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?act=view-cap-nhat-hopdong&id=<?= $h['id'] ?>" class="btn btn-sm btn-warning">Sửa</a>

                                        <a href="index.php?act=xoa-hopdong&id=<?= $h['id'] ?>" class="btn btn-sm btn-danger"
